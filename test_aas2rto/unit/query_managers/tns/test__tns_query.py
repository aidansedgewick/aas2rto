...
from aas2rto.query_managers.tns.tns_query import (
    TNSQuery,
    TNSQueryError,
    TNSQueryWarning,
)
...
@pytest.fixture
def tquery():
    return TNSQuery("test_user", 1234, query_sleep_time=0.0)
...
class Test__StaticProcessRespone:
    ...
    def test__process_to_pandas(self, mock_daily_delta: str):
        ...
        # Act
        df = TNSQuery.process_zip_content(bytes_data, return_type="pandas")
    ...
    def test__process_to_astropy(self, mock_daily_delta: str):
        ...
        # Act
        tab = TNSQuery.process_zip_content(bytes_data, return_type="astropy")
...
class Test__StaticCheckReturnType:
    def test__bad_type(self):
        # Act
        with pytest.raises(TNSQueryError):
            TNSQuery.check_return_type("bad_type")


class Test__SubmitPublicObjectRequest:
    def test__bad_request(self, tquery: TNSQuery):
        # Arrange
        url = f"{TNSQuery.tns_public_objects_url}/bad_request.csv.zip"

        # Act
        with pytest.warns(TNSQueryWarning):
...
class Test__GetDailyDelta:
    def test__return_pandas(self, tquery: TNSQuery):
        ...
        # Act
        df = tquery.get_tns_daily_delta(t_ref, return_type="pandas")
    ...
    def test__return_empty_pandas(self, tquery: TNSQuery):
        # Arrange
    ...
    def test__return_astropy(self, tquery: TNSQuery):
        # Arrange
        t_ref = Time("2023-02-24 00:00:00")  # The day before t_fixed

        # Act
        tab = tquery.get_tns_daily_delta(t_ref, return_type="astropy")
    ...
    def test__return_empty_astropy(self, tquery: TNSQuery):
        # Arrange
        t_ref = Time("2023-02-23 00:00:00")  # TWO days before t_fixed
    ...
    def test__return_records(self, tquery: TNSQuery):
        # Arrange
        t_ref = Time("2023-02-24 00:00:00")  # The day before t_fixed

        # Act
        records = tquery.get_tns_daily_delta(t_ref, return_type="records")
    ...
    def test__return_unprocessed(self, tquery: TNSQuery):
        # Arrange
        t_ref = Time("2023-02-24 00:00:00")  # The day before t_fixed

        # Act
        resp = tquery.get_tns_daily_delta(t_ref, process=False)
...
class Test__GetHourlyDelta:
    ...
    # TNSQuery does NOT delete old hourly deltas. That happens in TNS QM

    def test__return_pandas(self, tquery: TNSQuery):
        # Act
        df = tquery.get_tns_hourly_delta(0, return_type="pandas")
    ...
    def test__return_empty_pandas(self, tquery: TNSQuery):
        # Act
        df = tquery.get_tns_hourly_delta(1, return_type="pandas")
    ...
    def test__return_astropy(self, tquery: TNSQuery):
        # Act
        tab = tquery.get_tns_hourly_delta(0, return_type="astropy")
    ...
    def test__return_empty_astropy(self, tquery: TNSQuery):
        # Act
        tab = tquery.get_tns_hourly_delta(1, return_type="astropy")
    ...
    def test__return_records(self, tquery: TNSQuery):
        # Act
        records = tquery.get_tns_hourly_delta(0, return_type="records")
    ...
    def test__return_unprocessed(self, tquery: TNSQuery):
        # Act
        resp = tquery.get_tns_hourly_delta(0, process=False)
